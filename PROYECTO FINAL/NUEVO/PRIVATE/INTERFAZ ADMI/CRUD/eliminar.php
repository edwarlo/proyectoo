...
<body>
    ...
    <div class="contenedor__eliminar">
        <p>NOTA: Ingrese el número de documento del usuario a eliminar</p>
        <div class="elimi">
            <form action="$" method="post">
                ...
                <div class="dato"  id="content2">
                    <input class="campo__texto" disabled  type="text" required name="primer__nombre"  placeholder=" ">
                    <label>Primer Nombre</label><font color="red"> *</font>
                </div>
                <div class="dato" id="content1">
                    <input class="campo__texto" disabled  type="text" required name="segundo__nombre"  placeholder=" ">
                    <label>Segundo Nombre</label>
                </div>
                <div class="dato" id="content2">
                    <input class="campo__texto" disabled  type="text" required name="primer__apellido"  placeholder=" ">
                    <label>Primer Apellido</label><font color="red"> *</font>
                </div>
                <div class="dato" id="content1">
                    <input class="campo__texto" disabled  type="text" required name="segundo__apellido"  placeholder=" ">
                    <label>Segundo Apellido</label><font color="red"> *</font>
                </div>
                <div class="select" id="content2">
                    <label>Tipo Documento: </label>
                    <select name="tipo__documento" id="tipo__documento" required disabled>

                    </select><font color="red"> *</font>
                </div>
                <div class="dato" id="content1">
                    <input class="campo__texto" disabled  type="email required" name="correo"  placeholder=" ">
                    <label>Correo</label><font color="red"> *</font>
                </div>
                <div class="dato" id="content2">
                    <input class="campo__texto" disabled  type="text" required name="numero__telefono"  placeholder=" ">
                    <label>Numero Telefono</label><font color="red"> *</font>
                </div>
                <div class="dato" id="content1">
                    <input class="campo__texto" disabled  type="passw requiredord" name="contraseña"  placeholder=" ">
                    <label>Contraseña</label><font color="red"> *</font>
                </div>
                <div class="dato" id="content2">
                    <input class="campo__texto" disabled  type="email required" name="confirmar__contraseña" placeholder=" ">
                    <label>Confirmar Contraseña</label><font color="red"> *</font>
                </div>
                <div class="dato" id="content1">
                    <input class="campo__texto" disabled  type="text" required name="nombre__tienda"  placeholder=" ">
                    <label>Nombre Tienda</label><font color="red"> *</font>
                </div>
                <div class="select" id="content2">
                    <label >Rol: </label>
                    <select name="rol" id="rol" required disabled>
                        
                    </select><font color="red"> *</font>
                </div>
                    <input type="button" value="Eliminar" class="btn__actualizar">
